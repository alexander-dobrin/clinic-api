export const TYPES = {
    ...
    PATIENTS_FILE_DATA_PROVIDER: Symbol.for('PATIENTS_FILE_DATA_PROVIDER'),
    DOCTORS_FILE_DATA_PROVIDER: Symbol.for('DOCTORS_FILE_DATA_PROVIDER'),
    APPOINTMENTS_FILE_DATA_PROVIDER: Symbol.for('APPOINTMENTS_FILE_DATA_PROVIDER'),
